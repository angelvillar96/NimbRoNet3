"""
Training the complete NimbRoNet2 model for real-time detection and
segmentation on the soccer field.
"""
...
from lib.visualizations import visualize_img_target_pred


@for_all_methods(log_function)
class Trainer(BaseTrainer):
    """
    Class for training and validating a NimbRoNet2 model for real-time detection and
    segmentation on the soccer field.
    """
    ...
    def train_epoch(self, epoch):
        ...
        n_batch_lim = min(len(self.det_train_loader), len(self.seg_train_loader))
        ...
        total = average_det_loss_vals["_total"] + average_seg_loss_vals["_total"]
    ...
    def valid_epoch(self, epoch):
        ...
        n_batch_lim = min(len(self.det_valid_loader), len(self.seg_valid_loader))
